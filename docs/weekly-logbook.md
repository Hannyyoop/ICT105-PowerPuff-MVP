...
### What We Completed
1. Done discussing the project's initial ideas
2. Done creating repositories
...
### Lab 8 Reflection
In Lab 8, we transitioned from high-fidelity prototyping to customer validation and data analytics by importing our user testing results into Power BI[cite: 1]. We established key DAX measures—including Task Success Rate, Average Ease of Use, Confusion Rate, and Interest Rate—to transform raw user feedback into structured, quantitative metrics[cite: 1]. By building an interactive validation dashboard with KPI cards, behavioral charts, and slicers, we were able to pinpoint exact friction points in our booking flow and make an evidence-based decision regarding our MVP's readiness[cite: 1].
